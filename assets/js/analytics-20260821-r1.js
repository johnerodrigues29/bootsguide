    ...
    banner.innerHTML =
      '<div class="consent-banner-inner">' +
        '<div class="consent-copy">' +
          '<strong id="analytics-consent-title">Help us improve BootsGuide</strong>' +
          '<p>We use Google Analytics to understand which guides are useful. Analytics loads only if you accept. <a href="/privacy-policy/">Privacy policy</a></p>' +
        '</div>' +
        '<div class="consent-actions">' +
          '<button class="consent-btn consent-btn-secondary" type="button" data-consent-reject>Reject</button>' +
          '<button class="consent-btn consent-btn-primary" type="button" data-consent-accept>Accept analytics</button>' +
        '</div>' +
      '</div>';
