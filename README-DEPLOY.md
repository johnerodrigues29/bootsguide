...
Os arquivos de estilo e JavaScript são versionados como `style-v1.css` e `main-v1.js`; os cabeçalhos Cloudflare permitem cache longo para esses recursos, enquanto o HTML permanece revalidável. Ao alterar CSS ou JS em produção, publique uma nova versão de arquivo e atualize as referências HTML.
