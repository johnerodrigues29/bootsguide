...
> **Nota editorial:** os reviews, comparações, guias, páginas de categoria e hubs finalizados estão liberados para indexação. Somente `404.html`, Política de Privacidade e Termos permanecem com `noindex,follow`. O sitemap contém as 21 URLs editoriais indexáveis e foi atualizado em 21/08/2026.
